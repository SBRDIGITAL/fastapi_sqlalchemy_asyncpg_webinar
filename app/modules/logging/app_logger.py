...
def get_app_logger(
    logger_name: str,
    level: Literal["DEBUG", "FATAL", "ERROR", "WARN", "INFO"] = "INFO",
...
# # Логгер для ботов (не используется в этом проекте)
# bot_logger = get_app_logger(logger_name='bot_logs', level='DEBUG')

# # Логгер для миддлвейров (не используется в этом проекте)
# middlewares_logger = get_app_logger(logger_name='middlewares_logger', level='DEBUG')
